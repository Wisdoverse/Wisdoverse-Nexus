...
- Existing model detail: [tenant-model.md](https://github.com/gbrothersgroup/Nexis/blob/main/docs/en/architecture/tenant-model.md)
- ADRs: [docs/adr](https://github.com/gbrothersgroup/Nexis/tree/main/docs/adr)
