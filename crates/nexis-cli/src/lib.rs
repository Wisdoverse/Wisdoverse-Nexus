...
#[command(
    name = "nexis-cli",
    version,
    about = "Wisdoverse Nexus command line client",
    long_about = "Wisdoverse Nexus command line client for creating rooms, sending messages, and connecting over WebSocket"
)]
pub struct Cli {
    #[arg(
        long,
