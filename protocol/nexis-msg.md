# Wisdoverse Nexus Message Protocol (NIP-002)

## 概述

Wisdoverse Nexus Message Protocol 定义了人类和 AI 之间交换的消息格式。
...
```json
{
  "type": "code",
  "language": "python",
  "code": "print('Hello, Wisdoverse Nexus!')"
}
```
...
```json
{
  "type": "tool_call",
  "toolId": "web_search",
  "arguments": { "query": "Wisdoverse Nexus protocol" }
}
```
