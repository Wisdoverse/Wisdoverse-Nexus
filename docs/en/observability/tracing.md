...
Wisdoverse Nexus Gateway supports distributed tracing via OpenTelemetry Protocol (OTLP).
...
```
┌─────────────────┐     OTLP/gRPC     ┌──────────────────┐
│  Wisdoverse Nexus Gateway  │ ─────────────────▶│ OTLP Collector   │
...
Wisdoverse Nexus Gateway automatically captures:
