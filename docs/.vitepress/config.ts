...
export default defineConfig({
  ...
  description:
    'Open-source AI-native collaboration infrastructure for real-time rooms, identity, WebSocket messaging, and extensible workflows.',
  ...
  head: [
    ...
    [
      'meta',
      {
        name: 'keywords',
        content:
          'Wisdoverse Nexus, open source collaboration, WebSocket, Rust, AI collaboration, real-time messaging',
      },
    ],
    ...
    sidebar: {
      ...
      '/zh-CN/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '安全审计', link: '/zh-CN/security/audit-report' },
